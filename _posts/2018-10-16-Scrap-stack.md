...
Creamos la funcion info\_extract la cual se encargara de estraer y convertir en un data frame los nodos que busquemos
...
Creamos la funcion related\_tags para obtener un data.frame con los lenguajes que mas se relacionan con los lenguajes populares
...
```
    ...
    ## 1 javascript     jquery 515954
    ## 2 javascript       html 314479
    ## 3 javascript        css 145287
...
![](scrap-stack_files/figure-markdown_github/unnamed-chunk-11-1.png)
